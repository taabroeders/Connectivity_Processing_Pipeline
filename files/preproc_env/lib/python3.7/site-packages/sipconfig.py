...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/bin',
    'default_mod_dir':    '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/lib/python3.7/site-packages',
    'default_sip_dir':    '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/include/python3.7m',
    'py_inc_dir':         '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/include/python3.7m',
    'py_lib_dir':         '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/lib/python3.7/config',
    'py_version':         0x030700,
    'qt_framework':       0,
    'sip_bin':            '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/bin/sip',
    'sip_config_args':    '--sysroot=/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment',
    'sip_inc_dir':        '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/include/python3.7m',
    'sip_mod_dir':        '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/lib/python3.7/site-packages',
