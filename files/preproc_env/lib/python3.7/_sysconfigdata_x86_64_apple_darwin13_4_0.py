...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment=/usr/local/src/conda-prefix '
 ...
 'LIBPL': '/scratch/anw/tabroeders/Full_Processing_Pipeline_luna/files/python-environment/lib/python3.7/config-3.7m-darwin',
