...
exclude=$1
SEGFOLDER=$(realpath $2)
FREESURFER_DIR=$(realpath $3)
...
${FILEDIR}/singularity/MRtrix3.sif 5ttedit - 5TT.mif -none brain_stem_crop.mif -force
${FILEDIR}/singularity/MRtrix3.sif mv 5TT.mif result.mif
